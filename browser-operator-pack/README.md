# Browser Operator Pack

Служебная папка с установочными файлами для навыков:

- [`camofox-browser-operator`](../camofox-browser-operator)
- [`browser-form-workflows`](../browser-form-workflows)
...
Готовый prompt для вставки в Hermes: [`INSTALL_PROMPT.md`](./INSTALL_PROMPT.md).
